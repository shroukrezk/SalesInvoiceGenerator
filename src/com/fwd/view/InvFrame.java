...
import com.fwd.controller.SalesInvListener;
...
public class InvFrame extends javax.swing.JFrame {
    ...
    private List<InvHeader> invoicesList = new ArrayList<>();
    private InvHeaderTableModel invoiceHeaderTableModel;
    private InvLinesTableModel invoiceLinesTableModel;
    private InvHeaderDialog headerDialog;
    private InvLineDialog lineDialog;
    private SalesInvListener listener = new SalesInvListener(this);

    public SalesInvListener getListener() {
        return listener;
    }
    ...
    public void setInvoiceHeaderTableModel(InvHeaderTableModel invoiceHeaderTableModel) {
        this.invoiceHeaderTableModel = invoiceHeaderTableModel;
    }

    public void setInvoiceLinesTableModel(InvLinesTableModel invoiceLinesTableModel) {
    ...
    public List<InvHeader> getInvoicesList() {
        return invoicesList;
    }

    public InvHeaderTableModel getInvoiceHeaderTableModel() {
        return invoiceHeaderTableModel;
    }

    public InvLinesTableModel getInvoiceLinesTableModel() {
